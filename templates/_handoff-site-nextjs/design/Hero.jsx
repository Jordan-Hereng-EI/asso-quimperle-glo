(function () {
  const { Button, Eyebrow, StatBlock } = window.QuimperlGloDesignSystem_ce5208;
  ...
  function Hero({ onDonate }) {
    ...
    return (
      ...
      >
        {/* Cinematic background — slow ken-burns zoom */}
        <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
          <img
            src={(window.__resources && window.__resources.enfants) || "../../assets/enfants.jpg"}
        ...
        >
          <div style={{ maxWidth: "760px" }}>
            ...
            >
              L'Association Quimperlé-Glo œuvre pour l'éducation, la santé et l'autonomie des
              familles au Bénin. Chaque geste compte, chaque enfant compte.
            </p>
            <div
              style={{
                ...rise(700),
